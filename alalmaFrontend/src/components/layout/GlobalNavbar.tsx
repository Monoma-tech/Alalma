    ...
    <>
      <header className="bg-white border-b border-gray-200 sticky top-0 z-30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Desktop Layout */}
          <div className="hidden md:flex items-center py-4 space-x-4 lg:space-x-6">
            {/* Logo */}
          ...
          <div className="md:hidden">
            ...
            {isMobileMenuOpen && (
              <>
                ...
                />
                {/* Menu */}
                <div className="absolute left-0 right-0 top-full bg-white border-b border-gray-200 shadow-xl z-50 max-h-screen overflow-y-auto" ref={mobileMenuRef}>
                <div className="px-4 py-4 space-y-4 pb-safe">
                  ...
                  <div className="flex items-center pb-4 border-b border-gray-100">
                    ...
                    <div className="ml-3">
                      <p className="text-base font-medium text-gray-900">Usuario</p>
                      <div className="flex items-center">
                        <span className="w-2 h-2 bg-purple-500 rounded-full mr-2"></span>
                  ...
                  <div className="flex items-center justify-around py-3 bg-gray-50 rounded-lg">
                    ...
                    >
                      ...
                      <span className="text-xs text-gray-600 mt-1">Carrito</span>
                    </Button>
                  ...
                  <div className="space-y-2">
                    <button
                      ...
                      className="flex items-center w-full px-4 py-3 text-base text-gray-700 hover:bg-gray-50 rounded-lg cursor-pointer"
                    >
                    ...
                    <button
                      ...
                      className="flex items-center w-full px-4 py-3 text-base text-purple-700 hover:bg-purple-50 rounded-lg cursor-pointer"
                    >
